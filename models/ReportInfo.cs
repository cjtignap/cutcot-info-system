...
namespace cutcot_info_system.models
{
    public class ReportInfo
    {
        ...
        public ReportInfo(string report_type, string nature_of_dispute, int page_no, string case_no, string record_photo, DateTime first_hearing, PartyInformation first_party_info, PartyInformation second_party_info)
        {
